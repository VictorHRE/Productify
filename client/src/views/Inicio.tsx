        ...
        <div className="grid grid-cols-2 items-center p-6 gap-8 md:p-10 lg:m-5 max-lg:grid-cols-1">
          <div className="max-lg:text-center" data-aos="fade-right">
            ...
            <p className="mb-6 mt-6 text-lg text-gray-800 dark:text-white">
              En Productify, nos especializamos en ofrecer soluciones innovadoras para la gestión de inventarios. 
              Nuestro objetivo es ayudarte a organizar tus tareas, optimizar tus procesos y alcanzar tus metas 
              de manera eficiente. Con herramientas intuitivas y funcionales, Productify está diseñado para 
              simplificar tu día a día y maximizar tu productividad.
            </p>

            <button className="min-w-[30%] bg-blue-500 text-white font-bold py-2 px-4 rounded-full 
              hover:bg-blue-700 transition-all duration-300 shadow-md 
              dark:hover:bg-blue-500 dark:hover:shadow-sm dark:hover:shadow-blue-500"
            >
              Explorar más
            </button>
        ...
        <div className="grid grid-cols-2 items-center p-6 gap-8 md:p-12 lg:m-5 max-lg:grid-cols-1">
          ...
          <div className="max-lg:text-center" data-aos="fade-down">
            ...
            <p className="mb-4 mt-4 text-lg text-gray-800 dark:text-white">
              En Productify, nos dedicamos a ofrecer soluciones innovadoras para la gestión de inventarios agrícolas. 
              Nuestro objetivo es optimizar la eficiencia y la rentabilidad de tu negocio, ayudándote a gestionar tus 
              productos de manera precisa y automatizada.
            </p>

            <button className="mt-6 bg-green-500 text-white font-bold py-2 px-4 rounded-full 
        ...
        <div className="flex flex-col items-center p-8 gap-4 lg:m-5">
          <div className="w-full max-w-4xl" data-aos="flip-up">
            ...
            <p className="mt-4 text-lg text-center text-gray-800 dark:text-white">
              En Productify, ofrecemos una gama completa de soluciones diseñadas para facilitar la gestión de inventario agrícola. 
              Desde el seguimiento preciso de productos hasta la automatización de procesos, nuestro objetivo es proporcionar 
              herramientas que optimicen la eficiencia y la rentabilidad de tu negocio.
            </p>
          </div>
          ...
          >
            <div data-aos="zoom-out-right">
              ...
              <p className="mt-4 text-gray-800 dark:text-white">
                Ofrecemos herramientas avanzadas para un control detallado y preciso de tu inventario, 
                asegurando que siempre tengas la información que necesitas al alcance de tu mano.
              </p>
            </div>
            ...
            <div data-aos="zoom-in">
              ...
              <p className="mt-4 text-gray-800 dark:text-white">
                Simplifica la gestión de tus productos con nuestras soluciones diseñadas para optimizar 
                procesos y mejorar la productividad de tu negocio.
              </p>
            </div>
            ...
            <div data-aos="zoom-out-left">
              ...
              <p className="mt-4 text-gray-800 dark:text-white">
                Genera reportes detallados y realiza análisis de stock para tomar decisiones informadas 
      ...
      >
        <div className="flex flex-col items-center p-8 gap-14 mb-8 lg:m-5">
          <div className="w-full max-w-4xl" data-aos="zoom-out">
            ...
            <p className="mt-4 text-lg text-center text-gray-800 dark:text-white">
              En Productify, creemos en el poder de la comunidad. Juntos, podemos compartir conocimientos, 
              experiencias y crecer como profesionales en la gestión de inventarios y automatización de procesos.
            </p>
          </div>
          ...
          <div className="flex max-md:flex-col items-center gap-4">
            ...
            >
              ...
              <p className="mt-4 text-sm text-gray-800 dark:text-white">
                ¡Hola! Soy Víctor Romero, un Desarrollador Full Stack e Ingeniero en Computación de Nicaragua. 
                Me apasiona transformar lógica de negocio compleja en software limpio y escalable. Este proyecto, Productify, 
                está diseñado para ayudarte a organizar tus tareas, optimizar tu tiempo y alcanzar tus metas de manera eficiente. 
                ¡Espero que lo disfrutes y encuentres valor en él!
              </p>
            </div>
          </div>
        </div>
